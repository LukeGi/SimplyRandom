...
public class BoxRenderer {
    ...
    private BoxRenderer(Color color) {
     ...
     */
    public static BoxRenderer create(Color color, Vec3d pos1, Vec3d pos2) {
     ...
     * @return The created box.
     */
    public static BoxRenderer create(Color color, Vec3d pos1, Vec3d pos2, BoxMode mode) {
        BoxRenderer box = new BoxRenderer(color);
        box.position[0] = pos1.x;
        box.position[1] = pos1.y;
        box.position[2] = pos1.z;
        box.position[3] = pos2.x;
        box.position[4] = pos2.y;
        box.position[5] = pos2.z;
        box.mode = mode;
        return box;
    }
    ...
    public void show() {
        ...
        BufferBuilder wr = Tessellator.getInstance()
                .getBuffer();
