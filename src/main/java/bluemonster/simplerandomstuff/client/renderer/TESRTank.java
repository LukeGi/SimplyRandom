...
import bluemonster.simplerandomstuff.tanks.TileTank;
...
public class TESRTank
    ...
    public void render(TileTank te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        // NORTH
        renderer.pos(x1, y1, z1)
                .color(r, g, b, a)
                .tex(u1, v1)
                .lightmap(l1, l2)
                .endVertex();
        renderer.pos(x1, y2, z1)
                .color(r, g, b, a)
                .tex(u1, v2)
                .lightmap(l1, l2)
                .endVertex();
        renderer.pos(x2, y2, z1)
                .color(r, g, b, a)
                .tex(u2, v2)
                .lightmap(l1, l2)
                .endVertex();
        renderer.pos(x2, y1, z1)
                .color(r, g, b, a)
                .tex(u2, v1)
                .lightmap(l1, l2)
                .endVertex();
        ...
        // SOUTH
        renderer.pos(x2, y1, z2)
                .color(r, g, b, a)
                .tex(u1, v1)
                .lightmap(l1, l2)
                .endVertex();
        renderer.pos(x2, y2, z2)
                .color(r, g, b, a)
                .tex(u1, v2)
                .lightmap(l1, l2)
                .endVertex();
        renderer.pos(x1, y2, z2)
                .color(r, g, b, a)
                .tex(u2, v2)
                .lightmap(l1, l2)
                .endVertex();
        renderer.pos(x1, y1, z2)
                .color(r, g, b, a)
                .tex(u2, v1)
                .lightmap(l1, l2)
                .endVertex();
