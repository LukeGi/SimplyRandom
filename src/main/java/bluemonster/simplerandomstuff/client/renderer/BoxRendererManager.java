...
public class BoxRendererManager {
    ...
    private static List<BoxRenderer> renders = new ArrayList<>();

    private BoxRendererManager() {
    }

    public void addBox(BoxRenderer r) {
        renders.add(r);
    }

    public void removeBox(BoxRenderer r) {
        renders.remove(r);
    }
    ...
    public void renderHook(RenderWorldLastEvent e) {
        ...
        renders.forEach(BoxRenderer::render);
