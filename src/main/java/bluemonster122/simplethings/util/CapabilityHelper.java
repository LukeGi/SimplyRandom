...
{
	private static Predicate<Capability<?>> isItemHandler = capability -> capability.equals(
	...
	public static boolean hasCapability(TileEntity tileEntity, Capability<?> capability)
	{
		...
		{
			return isEnergyHandler.test(capability) && tileEntity instanceof IEnergyStorage;
		}
	}
}
