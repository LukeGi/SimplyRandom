...
public class RenderHelper {
     ...
     */
    public static void drawBox(VertexBuffer wr, float r, float g, float b, float a, double xmin, double ymin, double zmin, double xmax, double ymax, double zmax) {
     ...
     * @param zmax Maximum z value
     */
    public static void drawBoxWithoutEnds(VertexBuffer wr, float r, float g, float b, float a, double xmin, double ymin, double zmin, double xmax, double ymax, double zmax) {
        GL11.glColor4d(r, g, b, a);
        GlStateManager.color(r, g, b, a);
     ...
     * @param zmax Maximum z value
     */
    public static void drawBoxLines(VertexBuffer wr, double xmin, double ymin, double zmin, double xmax, double ymax, double zmax) {
