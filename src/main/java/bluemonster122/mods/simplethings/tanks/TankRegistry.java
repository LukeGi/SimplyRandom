...
public class TankRegistry implements IFeatureRegistry {
    public static final IFeatureRegistry INSTANCE = new TankRegistry();
    ...
    public void registerTileEntities() {
        GameRegistry.registerTileEntityWithAlternatives(TileTank.class, tank.getRegistryName().toString(), "tileTank");
    }
    ...
    public void registerRenders() {
        registerIEnumMeta(tank, BlockTank.EnumTankType.values());
        registerIEnumMeta(upgrade, ItemTankUpgrade.EnumTankUpgrade.values());
