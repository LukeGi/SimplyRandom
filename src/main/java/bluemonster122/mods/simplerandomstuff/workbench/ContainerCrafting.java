...
public class ContainerCrafting extends Container {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            if (index == 0)
            {
                itemstack1.getItem().onCreated(itemstack1, this.tile.getWorld(), playerIn);
    ...
    public void onCraftMatrixChanged(IInventory inventoryIn) {
        this.craftResult.setInventorySlotContents(0, CraftingManager.findMatchingRecipe(this.craftMatrix, tile.getWorld()).getRecipeOutput());
    }
