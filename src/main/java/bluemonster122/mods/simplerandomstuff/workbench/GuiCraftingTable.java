  ...
  extends GuiContainer
{
  ...
  protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
  {
    ...
    this.fontRenderer.drawString(I18n.format(string), 28, 6, 4210752);
  ...
  public static class GuiCraftingTableAuto
    extends GuiCraftingTable
  {
    TileCraftingTable.TileCraftingTableAuto tile;
    
    public GuiCraftingTableAuto(
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
      ...
      if (stack != ItemStack.EMPTY)
      {
        ...
        this.fontRenderer.drawString(msg, 132 - msgWidth / 2, 65, 4210752);
      }
    }
